      ...
      <div className="grid gap-4 lg:grid-cols-[420px_1fr]">
        ...
        <div className="card flex flex-col gap-4 p-5">
          ...
          <div>
            ...
            <div className="mt-1 text-[11px] text-ink-subtle">Contoh: tempel URL desain referensi, akan dipakai sebagai konteks tambahan saat generate.</div>
          </div>
        ...
        <div className="card flex min-h-[600px] flex-col p-0 overflow-hidden">
          ...
          {generating ? (
            ...
            <div className="flex flex-1 flex-col">
              <pre
                className="flex-1 overflow-auto bg-[#0b1020] p-4 text-[12px] leading-relaxed text-[#cbd5e1]"
                style={{
                  fontFamily: "ui-monospace, SFMono-Regular, Menlo, monospace",
                }}
              >
